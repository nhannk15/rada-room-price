...
public class ListingController {
    ...
    @PostMapping
    public ResponseEntity<?> createListing(@RequestBody @Valid CreateListingRequest createListingRequest) {
        ListingDTO response = listingService.createListing(createListingRequest);
